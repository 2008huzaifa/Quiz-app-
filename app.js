// var arr = [];
// let users = localStorage.getItem('object');
...
// var filter = arr.filter(data=> data.emails === email.value && data.passwords === password.value)
...
//     localStorage.setItem('Password',uppassword.value)
...
//     if(localStorage.getItem('Email') == inEmail.value
//      && 
//      localStorage.getItem('Password') == inPassword.value){
//         alert(" login successfull")
//      location.href = 'welcome.html'
//     }
//     else{
//         alert("Un suuccessfull")
